...
namespace Wrap.Json.Converters.IdJsonConverter_Tests;
...
public class WriteJson_Tests
{
	...
	{
		// Arrange
		var guidId = IdGen.GuidId<TestGuidId>();
		var intId = IdGen.IntId<TestIntId>();
		var longId = IdGen.LongId<TestLongId>();
