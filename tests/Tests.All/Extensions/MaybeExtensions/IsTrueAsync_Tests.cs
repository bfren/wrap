...
public class IsTrueAsync_Tests
{
	public class With_None
	{
		...
		public async Task Returns_False()
		{
			...
			// Act
			var result = await input.AsTask().IsTrueAsync();
	...
	{
		[Fact]
		public async Task Value_Is_True__Returns_True()
		{
			// Arrange
		...
		[Fact]
		public async Task Value_Is_False__Returns_False()
		{
			// Arrange
