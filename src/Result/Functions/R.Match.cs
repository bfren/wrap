...
public static partial class R
{
	...
	/// potential for not handling both cases (<see cref="Ok{T}"/> and <see cref="Wrap.Err"/>).
	/// </para>
	/// <para>
	...
	/// <param name="err">Function to run when <paramref name="result"/> is <see cref="Wrap.Err"/>.</param>
	...
	/// <inheritdoc cref="Match{T}(Result{T}, Action{ErrValue}, Action{T})"/>
