...
public static partial class M
{
	...
	/// potential for not handling both cases (<see cref="Some{T}"/> and <see cref="Monads.None"/>).
	/// </para>
	/// <para>
	...
	/// <param name="none">Function to run when <paramref name="maybe"/> is <see cref="Monads.None"/>.</param>
